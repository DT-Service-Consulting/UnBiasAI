test_queries = [
    "Calendar settings?", # 3986
    "Bannière?", # 3987
    "What are the cafeteria plan benefits?", # 3989
    "What about my car configuration offer?", # 3990
    "How do I create a Canva?", # 3991
    "Card for Chargemap Business - Charging solutions for companies?", # 3992
    "Best practices for linkedin according to David's BB project?", # 3993
    "What about Chargemap charging station?", # 3994
    "What about Connecting Expertise?", # 3995
    "What's the BeCentral address?", # 3996
    "What about a Microsoft 365 license?", # 3997
    "Is having a DTSC Google account a prerequisite and what happens if I download the extension and do I need a teams pictogram?", #3998
    "How to modify a page on dtsc.be?", # 3999
    "What are compensatory rest days?", # 4000
    "How do I access the shared library on the SharePoint?", # 4001
    ...
    "Can I contact the CEO a green card?", # 4014
    ...
    "Do I need Two-factor authentication for odoo?", # 4030
